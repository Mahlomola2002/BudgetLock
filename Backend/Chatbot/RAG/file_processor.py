...
class FileProcessor:
    def __init__(self, cache_folder: str = None, embed_model: str = "sentence-transformers/paraphrase-MiniLM-L6-v2"):
        self.embed_model = HuggingFaceEmbedding(model_name=embed_model, cache_folder=cache_folder)
    ...
    def process_file(self, file_path: str, index_name: str = "file_index"):
        # Load file
    ...
    def query(self, query_text: str) -> str:
        if self.index is None:
            raise ValueError("Index not created or loaded. Please process a file or load an existing index first.")
